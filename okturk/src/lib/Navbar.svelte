...
{#if !isMobile}
    <div class="m-0 p-0 sticky transition top-0 z-50 flex flex-row shadow-xl bg-slate-50 border-b-4 border-orange-600">
        <div class="flex flex-col basis-1/4 justify-center px-4">
            <h1 class="text-xl text-center font-bold">OKTurk</h1>
        </div>
...
{:else}
    <div class="m-0 p-2 sticky top-0 z-40 flex flex-row justify-center bg-slate-100 shadow-xl">
        <div class="flex flex-col justify-center">
            <h1 class="text-3xl text-center font-bold">OKTurk</h1>
        </div>
    </div>
